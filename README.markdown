...
This directory contains source files for the Tatar language morphology
...
-   <https://giellalt.uit.no/lang/tat/index.html> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
------------

In order to compile and use Tatar language morphology and dictionaries,
you need:
...
The Tatar language sources can be acquired using [giella SVN
